...
zathura_error_t jpg_page_init(zathura_page_t* page) {
  if (page == NULL) {
...
zathura_error_t jpg_page_clear(zathura_page_t* page, void* data) {
  if (page == NULL) {
    return ZATHURA_ERROR_INVALID_ARGUMENTS;
  }
...
zathura_error_t jpg_page_render_cairo(zathura_page_t* page, void* data, cairo_t* cairo, bool printing) {
